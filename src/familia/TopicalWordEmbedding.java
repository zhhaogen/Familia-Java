 ...
 */
public class TopicalWordEmbedding
{
...
public	static class WordAndDis
	{
		public String word;
	...
	int load_emb(String emb_file)
	{
		...
		try (BufferedInputStream br = new BufferedInputStream(new FileInputStream(emb_file));)
		{
			...
			Logger.d("#vocab_size=" + _vocab_size + "," + "#num_topics=" + _num_topics + "," + "#emb_size=" + _emb_size);
